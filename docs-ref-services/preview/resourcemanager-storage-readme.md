...
keywords: Azure, java, SDK, API, azure-resourcemanager-storage, resourcemanagerhybrid
...
---
# Azure Resource Manager storage client library for Java - Version 1.0.0-hybrid 
 (Hybrid)
