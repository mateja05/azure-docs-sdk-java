...
keywords: Azure, java, SDK, API, azure-analytics-synapse-artifacts, synapseanalytics
author: joshfree
ms.author: jfree
ms.date: 03/14/2022
ms.topic: reference
...
---
# Azure Synapse Artifacts client library for Java - Version 1.0.0-alpha.20220314.3 
