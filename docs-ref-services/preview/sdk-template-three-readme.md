...
ms.service: template
---
# Azure Template Three client library for Java - Version 1.0.0-alpha.20220415.11 
...
* Example: `# Azure Batch client library for Java - Version 1.0.0-alpha.20220415.11 
`
