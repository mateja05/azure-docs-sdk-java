...
ms.service: template
---
# Azure Template Three client library for Java - Version 1.0.0-alpha.20220428.20 
...
* Example: `# Azure Batch client library for Java - Version 1.0.0-alpha.20220428.20 
`
