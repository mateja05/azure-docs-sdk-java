...
keywords: Azure, java, SDK, API, azure-resourcemanager-containerregistry, resourcemanagerhybrid
...
---
# Azure Resource Manager Containerregistry client library for Java - Version 1.0.0-hybrid 
 (Hybrid)
