...
keywords: Azure, java, SDK, API, azure-resourcemanager-authorization, resourcemanager
...
---
# Azure Resource Manager Authorization client library for Java - Version 2.14.0-alpha.20220329.1 
