...
keywords: Azure, java, SDK, API, azure-resourcemanager-resources, resourcemanager
...
---
# Azure Resource Manager resources client library for Java - Version 2.15.0-alpha.20220415.3 
