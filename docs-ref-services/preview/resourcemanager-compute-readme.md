...
keywords: Azure, java, SDK, API, azure-resourcemanager-compute, resourcemanagerhybrid
...
---
# Azure Resource Manager Compute client library for Java - Version 1.0.0-hybrid 
 (Hybrid)
