...
keywords: Azure, java, SDK, API, azure-resourcemanager-recoveryservicesbackup, recoveryservices
author: joshfree
ms.author: jfree
ms.date: 03/12/2022
ms.topic: reference
...
---
# Azure Resource Manager RecoveryServicesBackup client library for Java - Version 1.0.0-alpha.20220311.1 
