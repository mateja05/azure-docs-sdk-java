...
keywords: Azure, java, SDK, API, azure-resourcemanager-monitor, resourcemanagerhybrid
...
---
# Azure Resource Manager monitor client library for Java - Version 1.0.0-hybrid 
 (Hybrid)
...
[api_profile]: /azure-stack/user/azure-stack-version-profiles
