...
keywords: Azure, java, SDK, API, azure-resourcemanager-keyvault, resourcemanagerhybrid
author: ramya-rao-a
ms.author: ramyar
ms.date: 03/31/2022
ms.topic: reference
...
---
# Azure Resource Manager keyvault client library for Java - Version 1.0.0-hybrid 
 (Hybrid)
