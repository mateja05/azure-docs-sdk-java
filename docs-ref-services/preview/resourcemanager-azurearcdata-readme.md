...
keywords: Azure, java, SDK, API, azure-resourcemanager-azurearcdata, azurearcdata
author: joshfree
ms.author: jfree
ms.date: 04/20/2022
ms.topic: reference
...
---
# Azure Resource Manager AzureArcData client library for Java - Version 1.0.0-alpha.20220420.1 
