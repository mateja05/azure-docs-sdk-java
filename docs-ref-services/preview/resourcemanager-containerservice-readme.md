...
keywords: Azure, java, SDK, API, azure-resourcemanager-containerservice, resourcemanagerhybrid
...
---
# Azure Resource Manager Containerservice client library for Java - Version 1.0.0-hybrid 
 (Hybrid)
